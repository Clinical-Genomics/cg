...
select * from family where family.data_analysis not in ('balsamic', 'fastq', 'microsalt', 'mip_dna', 'mip_rna');

ALTER TABLE `family` CHANGE `data_analysis` `data_analysis` ENUM('balsamic', 'fastq', 'microsalt', 'mip_dna', 'mip_rna')
 CHARACTER SET latin1
 COLLATE latin1_swedish_ci
 NOT NULL;
...
select * from analysis where analysis.pipeline not in ('balsamic', 'fastq', 'microsalt', 'mip_dna', 'mip_rna');

ALTER TABLE `analysis` CHANGE `pipeline` `pipeline` ENUM('balsamic', 'fastq', 'microsalt', 'mip_dna', 'mip_rna')
 CHARACTER SET latin1
 COLLATE latin1_swedish_ci
 NOT NULL;
