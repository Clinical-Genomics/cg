...
def get_samples_not_down_sampled(samples: Query, **kwargs) -> Query:
    """Get samples that are not down sampled."""
    return samples.filter(Sample.downsampled_to.is_(None))


def get_samples_down_sampled(samples: Query, **kwargs) -> Query:
...
def get_samples_do_not_invoice(samples: Query, **kwargs) -> Query:
...
class SampleFilters(Enum):
    ...
    get_samples_by_entry_id: Callable = get_samples_by_entry_id
    get_samples_is_delivered: Callable = get_samples_is_delivered
    get_samples_is_not_delivered: Callable = get_samples_is_not_delivered
    get_samples_by_invoice_id: Callable = get_samples_by_invoice_id
    get_samples_without_invoice_id: Callable = get_samples_without_invoice_id
    get_samples_not_down_sampled: Callable = get_samples_not_down_sampled
    get_samples_down_sampled: Callable = get_samples_down_sampled
    get_samples_is_sequenced: Callable = get_samples_is_sequenced
    get_samples_is_not_sequenced: Callable = get_samples_is_not_sequenced
    get_samples_do_invoice: Callable = get_samples_do_invoice
    get_samples_do_not_invoice: Callable = get_samples_do_not_invoice
    get_samples_by_customer_name: Callable = get_samples_by_customer_name
    get_samples_by_customer_id: Callable = get_samples_by_customer_id
    get_samples_is_received: Callable = get_samples_is_received
