...
def filter_application_is_dna(applications: Query, **kwargs) -> Query:
    ...
    return applications.filter(Application.prep_category.in_(dna_prep_categories))
...
class ApplicationFilter(Enum):
    ...
    IS_DNA = filter_application_is_dna
