...
def get_samples_by_customer(samples: Query, customer: Customer, **kwargs) -> Query:
...
def get_samples_by_identifier_name_and_value(
...
class SampleFilter(Enum):
    ...
    FILTER_BY_CUSTOMER: Callable = get_samples_by_customer
    FILTER_BY_CUSTOMER_ENTRY_IDS: Callable = get_samples_by_entry_customer_ids
    FILTER_BY_ENTRY_ID: Callable = get_samples_by_entry_id
    FILTER_BY_IDENTIFIER_NAME_AND_VALUE: Callable = get_samples_by_identifier_name_and_value
    FILTER_BY_INTERNAL_ID: Callable = get_samples_by_internal_id
    FILTER_BY_INTERNAL_ID_OR_NAME_SEARCH: Callable = get_samples_by_internal_id_or_name_search
    FILTER_BY_INTERNAL_ID_PATTERN: Callable = get_samples_by_internal_id_pattern
    FILTER_BY_INVOICE_ID: Callable = get_samples_by_invoice_id
    FILTER_BY_SAMPLE_NAME: Callable = get_samples_by_name
    FILTER_BY_SUBJECT_ID: Callable = get_samples_by_subject_id
    FILTER_DO_INVOICE: Callable = get_samples_do_invoice
    FILTER_HAS_NO_INVOICE_ID: Callable = get_samples_without_invoice_id
    FILTER_IS_DELIVERED: Callable = get_samples_is_delivered
    FILTER_IS_NOT_DELIVERED: Callable = get_samples_is_not_delivered
    FILTER_IS_NOT_DOWN_SAMPLED: Callable = get_samples_is_not_down_sampled
    FILTER_IS_PREPARED: Callable = get_samples_is_prepared
    FILTER_IS_NOT_PREPARED: Callable = get_samples_is_not_prepared
    FILTER_IS_RECEIVED: Callable = get_samples_is_received
    FILTER_IS_NOT_RECEIVED: Callable = get_samples_is_not_received
    FILTER_IS_SEQUENCED: Callable = get_samples_is_sequenced
    FILTER_IS_NOT_SEQUENCED: Callable = get_samples_is_not_sequenced
    FILTER_IS_TUMOUR: Callable = get_samples_is_tumour
    FILTER_IS_NOT_TUMOUR: Callable = get_samples_is_not_tumour
    FILTER_WITH_LOQUSDB_ID: Callable = get_samples_with_loqusdb_id
    FILTER_WITHOUT_LOQUSDB_ID: Callable = get_samples_without_loqusdb_id
    FILTER_WITH_TYPE: Callable = get_samples_with_type
