...
class SampleFilter(Enum):
    ...
    BY_CUSTOMER = filter_samples_by_customer
    BY_CUSTOMERS = filter_samples_by_customers
    BY_CUSTOMER_ENTRY_IDS = filter_samples_by_entry_customer_ids
    BY_ENTRY_ID = filter_samples_by_entry_id
    BY_IDENTIFIER_NAME_AND_VALUE = filter_samples_by_identifier_name_and_value
    BY_INTERNAL_ID = filter_samples_by_internal_id
    BY_INTERNAL_IDS = filter_samples_by_internal_ids
    BY_INTERNAL_ID_OR_NAME_SEARCH = filter_samples_by_internal_id_or_name_search
    BY_INTERNAL_ID_PATTERN = filter_samples_by_internal_id_pattern
    BY_INVOICE_ID = filter_samples_by_invoice_id
    BY_SAMPLE_NAME = filter_samples_by_name
    BY_SUBJECT_ID = filter_samples_by_subject_id
    BY_TUMOUR = filter_samples_on_tumour
    DO_INVOICE = filter_samples_do_invoice
    HAS_NO_INVOICE_ID = filter_samples_without_invoice_id
    IS_NOT_CANCELLED = filter_out_cancelled_samples
    IS_DELIVERED = filter_samples_is_delivered
    IS_NOT_DELIVERED = filter_samples_is_not_delivered
    IS_NOT_DOWN_SAMPLED = filter_samples_is_not_down_sampled
    IS_PREPARED = filter_samples_is_prepared
    IS_NOT_PREPARED = filter_samples_is_not_prepared
    IS_RECEIVED = filter_samples_is_received
    IS_NOT_RECEIVED = filter_samples_is_not_received
    IS_SEQUENCED = filter_samples_is_sequenced
    IS_NOT_SEQUENCED = filter_samples_is_not_sequenced
    LIMIT = apply_limit
    WITH_LOQUSDB_ID = filter_samples_with_loqusdb_id
    WITHOUT_LOQUSDB_ID = filter_samples_without_loqusdb_id
    WITH_TYPE = filter_samples_with_type
    ORDER_BY_CREATED_AT_DESC = order_samples_by_created_at_desc
