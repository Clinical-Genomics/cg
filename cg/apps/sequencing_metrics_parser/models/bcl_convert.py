...
class BclConvertQualityMetrics(BaseModel):
    ...
    lane: int = Field(
        ...,
        alias=BclConvertQualityMetricsColumnNames.LANE,
    )
...
class BclConvertDemuxMetrics(BaseModel):
    ...
    lane: int = Field(
        ...,
        alias=BclConvertDemuxMetricsColumnNames.LANE,
    )
    sample_internal_id: str = Field(
        ...,
        alias=BclConvertDemuxMetricsColumnNames.SAMPLE_INTERNAL_ID,
    )
    read_pair_count: int = Field(
        ...,
        alias=BclConvertDemuxMetricsColumnNames.READ_PAIR_COUNT,
    )
