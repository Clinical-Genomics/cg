...
from cg.apps.sequencing_metrics_parser.parsers.bcl2fastq_to_sequencing_statistics import (
    create_sequencing_metrics_for_bcl2fastq_flow_cell,
...
def create_sample_lane_sequencing_metrics_for_flow_cell(
    ...
    return create_sequencing_metrics_for_bcl2fastq_flow_cell(flow_cell_directory)
...
def create_undetermined_sequencing_metrics_for_flow_cell(
    ...
    if bcl_converter == BclConverter.BCL2FASTQ:
        return create_undetermined_sequencing_metrics_for_bcl2fastq_flow_cell(
            flow_cell_dir=flow_cell_directory,
            non_pooled_samples_and_lanes=non_pooled_lanes_and_samples,
        )
