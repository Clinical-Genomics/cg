        ...
        for lane in metrics_parser.get_lanes_for_sample_internal_id(
            ...
            sequencing_statistics.append(
                SampleLaneSequencingMetrics(
                    ...
                    sample_total_reads_in_lane=metrics_parser.calculate_total_reads_per_lane(
                        sample_internal_id=sample_internal_id, lane=lane
                    ),
                    sample_base_fraction_passing_q30=metrics_parser.get_q30_bases_percent_per_lane(
                        sample_internal_id=sample_internal_id, lane=lane
                    ),
                    sample_base_mean_quality_score=metrics_parser.get_mean_quality_score_per_lane(
                        sample_internal_id=sample_internal_id, lane=lane
                    ),
