...
class ParsedSequencingMetricsPerLaneAndSample:
    """
    Contains parsed data from the parsed bcl2fastq sequencing metrics output.
...
def parse_bcl2fastq_sequencing_metrics(stats_json_path):
    ...
    for conversion_result in data["ConversionResults"]:
        metrics = ParsedSequencingMetricsPerLaneAndSample()
