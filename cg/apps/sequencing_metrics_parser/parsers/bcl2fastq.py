...
def create_sequencing_statistics(
    ...
    yield_q30_total = calculate_total_yield_q30(lane_q30_yield_values)

    lane_yield_values = get_lane_yield_values(lane_read_metrics)
    total_lane_yield = calculate_total_lane_yield(lane_yield_values)
    ...
    perfect_index_reads_percent = calculate_perfect_index_reads_percent(
        perfect_reads_for_sample_in_lane, sample_lane_read_counts
    )
