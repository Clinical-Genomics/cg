...
class BclConvertMetricsParser:
    ...
    def get_undetermined_quality_metrics(self) -> List[BclConvertQualityMetrics]:
        undetermined_metrics: List[BclConvertQualityMetrics] = []
        for metrics in self.quality_metrics:
            if metrics.sample_internal_id == "Undetermined":
