...
class AddHandler:
    ...
    def add_analysis(cls, config_stream):
        ...
        if rna_analysis:
            sampleinfo_data = mip_files.parse_sampleinfo_rna(sampleinfo_raw)
        else:
        ...
        if rna_analysis:
            new_bundle = cls._build_bundle_rna(config_data, sampleinfo_data)
        else:
    ...
    @classmethod
    def _build_bundle_rna(cls, config_data: dict, sampleinfo_data: dict) -> dict:
        """Create a new bundle for RNA."""
        data = {
            'name': config_data['case'],
            'created': sampleinfo_data['date'],
            'pipeline_version': sampleinfo_data['version'],
            'files': cls._get_files_rna(config_data, sampleinfo_data),
        }
        return data
    ...
    @staticmethod
    def _get_files_rna(config_data: dict, sampleinfo_data: dict) -> dict:
