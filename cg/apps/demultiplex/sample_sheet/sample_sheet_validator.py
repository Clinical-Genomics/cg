...
class SampleSheetValidator:
    ...
    def _validate_samples(self) -> None:
        ...
        try:
            validated_samples: list[IlluminaSampleIndexSettings] = get_samples_from_content(
    ...
    def get_sample_sheet_object_from_file(self, file_path: Path) -> SampleSheet:
        ...
        samples: list[IlluminaSampleIndexSettings] = get_samples_from_content(self.content)
