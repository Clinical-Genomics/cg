...
class SampleSheetValidator:
    ...
    def _validate_samples(self) -> None:
        ...
        try:
            validated_samples: list[IlluminaIndexSettings] = get_flow_cell_samples_from_content(
    ...
    def get_sample_sheet_object_from_file(self, file_path: Path) -> SampleSheet:
        ...
        samples: list[IlluminaIndexSettings] = get_flow_cell_samples_from_content(self.content)
