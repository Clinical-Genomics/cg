...
class SampleSheetAPI:
    ...
    def _get_flow_cell(self, flow_cell_name: str) -> IlluminaRunDirectory:
        """
    ...
    @staticmethod
    def _are_necessary_files_in_flow_cell(flow_cell: IlluminaRunDirectory) -> bool:
    ...
    def translate_sample_sheet(self, flow_cell_name: str) -> None:
        ...
        flow_cell: IlluminaRunDirectory = self._get_flow_cell(flow_cell_name)
    ...
    def _use_sample_sheet_from_housekeeper(self, flow_cell: IlluminaRunDirectory) -> None:
        """
    ...
    def _use_flow_cell_sample_sheet(self, flow_cell: IlluminaRunDirectory) -> None:
    ...
    def _get_sample_sheet_content(self, flow_cell: IlluminaRunDirectory) -> list[list[str]]:
    ...
    def _create_sample_sheet_file(self, flow_cell: IlluminaRunDirectory) -> None:
