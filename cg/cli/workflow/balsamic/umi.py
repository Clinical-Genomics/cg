...
def config_case(context: CGConfig, panel_bed: str, case_id: str, dry_run: bool):
    """Create config file for BALSAMIC_UMI analysis for a given CASE_ID"""
...
def run(
    ...
    """Run balsamic_umi analysis for given CASE ID"""
    analysis_api: BalsamicUmiAnalysisAPI = context.meta_apis["analysis_api"]
    try:
...
@balsamic_umi.command("report-deliver")
@ARGUMENT_CASE_ID
@OPTION_DRY
@OPTION_ANALYSIS_TYPE
@click.pass_obj
...
@balsamic_umi.command("store-housekeeper")
@ARGUMENT_CASE_ID
@click.pass_obj
...
@balsamic_umi.command("store-available")
@OPTION_DRY
@click.pass_context
