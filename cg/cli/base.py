...
base.add_command(load_command("cg.cli.demultiplex.base", "demultiplex_cmd_group"))
base.add_command(load_command("cg.cli.generate.base", "generate"))
base.add_command(load_command("cg.cli.downsample", "downsample"))
base.add_command(load_command("cg.cli.post_process.post_process", "post_process_group"))
