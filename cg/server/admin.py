...
def view_application_version_link(unused1, unused2, model, unused3):
    ...
    # The filter names are auto generated by Flask
    query_params = {
        "flt0_0": model.application_version.application.tag,
        "flt2_1": model.application_version.version,
    }
    root: str = url_for("applicationversion.index_view")
    url: str = f"{root}?{urlencode(query_params)}"
...
class ApplicationVersionView(BaseView):
    ...
    column_filters = [
        FilterLike(Application.tag, name="tag"),
        FilterLike(ApplicationVersion.version, name="version"),
    ]
