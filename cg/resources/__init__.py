...
RAREDISEASE_BUNDLE_FILENAMES_PATH = Path(root_dir, RAREDISEASE_BUNDLE_FILENAMES)

RNAFUSION_BUNDLE_FILENAMES_PATH = Path(root_dir, RNAFUSION_BUNDLE_FILENAMES)

TAXPROFILER_BUNDLE_FILENAMES_PATH = Path(root_dir, TAXPROFILER_BUNDLE_FILENAMES)

TOMTE_BUNDLE_FILENAMES_PATH = Path(root_dir, TOMTE_BUNDLE_FILENAMES)
