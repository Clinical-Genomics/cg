...
RNAFUSION_BUNDLE_FILENAMES: str = Path("resources", "rnafusion_bundle_filenames").with_suffix(FileExtensions.YAML).as_posix()

TAXPROFILER_BUNDLE_FILENAMES: str = Path("resources", "taxprofiler_bundle_filenames").with_suffix(FileExtensions.YAML).as_posix()
