...
from cg.meta.orders.fastq_submitter import (
    FastqSubmitter,
)
from cg.meta.orders.fluffy_submitter import (
    FluffySubmitter,
)
from cg.meta.orders.metagenome_submitter import (
    MetagenomeSubmitter,
)
from cg.meta.orders.microsalt_submitter import (
    MicrosaltSubmitter,
)
...
from cg.meta.orders.rnafusion_submitter import (
    RnafusionSubmitter,
)
...
class OrdersAPI:
    ...
    def submit(
        ...
        """
        submit_handler: Submitter = _get_submit_handler(
            project,
            lims=self.lims,
            status=self.status,
        )
