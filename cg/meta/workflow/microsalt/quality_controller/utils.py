...
def has_valid_duplication_rate(
    metrics: SampleMetrics,
) -> bool:
...
def has_valid_median_insert_size(
    metrics: SampleMetrics,
) -> bool:
...
def has_valid_average_coverage(
    metrics: SampleMetrics,
) -> bool:
...
def get_negative_control_result(
...
def non_urgent_samples_pass_qc(
    results: list[SampleQualityResult],
) -> bool:
...
def is_sample_negative_control(
    sample: Sample,
) -> bool:
...
def get_sample_target_reads(
    sample: Sample,
) -> int:
    return sample.application_version.application.target_reads


def get_percent_reads_guaranteed(
    sample: Sample,
) -> int:
