...
class PreAnalysisQualityCheck:
    ...
    def standard_sequencing_qc(self) -> bool:
        ...
        """
        return all(self.sample.reads >= self.sample.expected_reads)
    ...
    def express_sequencing_qc(self) -> bool:
        ...
        """
        return self.sample.reads >= self.express_reads_threshold
    ...
    @property
    def express_reads_threshold(self) -> int:
        """
        ...
        """
        return round(self.sample.application_version.application.target_reads / 2)
    ...
    @classmethod
    def run_qc(cls, sample: Sample) -> bool:
        """
