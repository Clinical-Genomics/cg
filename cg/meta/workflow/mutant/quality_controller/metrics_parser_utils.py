...
def parse_samples_results(case: Case, results_file_path: Path) -> dict[str, SampleResults]:
    """Takes a case object and a results_file_path and resturns dict[str, SampleResults] with sample.internal_id as keys."""

    validated_results_list: list[SampleResults] = _get_validated_results_list(
...
def _get_validated_results_list(results_file_path: Path) -> list[SampleResults]:
...
def _get_samples_results(case: Case, results_list: list[SampleResults]) -> dict[str, SampleResults]:
