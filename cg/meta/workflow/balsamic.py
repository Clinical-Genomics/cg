...
class BalsamicAnalysisAPI(AnalysisAPI):
    ...
    def get_verified_samples(self, case_id: str, force_normal: bool) -> Dict[str, str]:
    ...
    def get_verified_config_case_arguments(
        ...
        config_case.update(self.get_verified_samples(case_id=case_id, force_normal=force_normal))
