...
class RnafusionConfigBuilder(ScoutConfigBuilder):
    ...
    def include_case_files(
        self, load_config: RnafusionLoadConfig, hk_version_obj: Version = None
    ) -> None:
        ...
        for scout_key in RNAFUSION_CASE_TAGS.keys():
            self._include_file(load_config, scout_key, hk_version_obj=hk_version_obj)
    ...
    def _include_file(
        self, load_config: RnafusionLoadConfig, scout_key: str, hk_version_obj: Version
    ) -> None:
