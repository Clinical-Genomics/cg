...
class BalsamicReportAPI(ReportAPI):
    ...
    def get_variant_callers(self, _analysis_metadata: BalsamicAnalysis) -> list:
        ...
        for (
            var_caller_name,
            var_caller_attributes,
        ) in var_callers.items():
            if (
                ...
                version: str = self.get_variant_caller_version(
                    var_caller_name=var_caller_name,
                    var_caller_versions=tool_versions,
                )
    ...
    def get_required_fields(self, case: CaseModel) -> dict:
        ...
        return {
            ...
            "samples": self.get_sample_required_fields(
                case=case,
                required_fields=REQUIRED_SAMPLE_BALSAMIC_FIELDS,
            ),
            ...
            "metadata": self.get_sample_required_fields(
                case=case,
                required_fields=required_sample_metadata_fields,
            ),
        }
