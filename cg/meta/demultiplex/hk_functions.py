...
def store_flow_cell_data_in_housekeeper(
    ...
    add_tags_if_non_existent(tag_names=tags)

    add_sample_sheet_path_to_housekeeper(
        flow_cell_directory=flow_cell.path, flow_cell_name=flow_cell.id
    )
    add_sample_fastq_files_to_housekeeper(flow_cell)
    add_demux_logs_to_housekeeper(flow_cell)
...
def store_fastq_path_in_housekeeper(
    ...
    sample_fastq_should_be_stored: bool = self.check_if_fastq_path_should_be_stored_in_housekeeper(
