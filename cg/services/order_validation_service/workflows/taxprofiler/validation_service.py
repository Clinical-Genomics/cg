...
from cg.services.order_validation_service.workflows.taxprofiler.validation_rules import SAMPLE_RULES
from cg.store.store import Store


class TaxprofilerValidationService(OrderValidationService):
    ...
    def _get_errors(self, raw_order: dict) -> ValidationErrors:
        order, field_errors = ModelValidator.validate(order=raw_order, model=TaxprofilerOrder)
