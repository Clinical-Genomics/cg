...
from cg.services.order_validation_service.workflows.mip_dna.models.order import (
    MipDnaOrder,
)
...
class MipDnaValidationService(OrderValidationService):
    ...
    def parse_and_validate(self, raw_order: dict) -> MipDnaOrder:
        pass
