...
class RarediseaseExtension(PipelineExtension):
    ...
    def configure(self, case_id: str, case_path: Path) -> None:
        ...
        self.sample_mapping_file_creator.create(case_id=case_id, case_path=case_path)
