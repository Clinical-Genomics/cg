...
TAXPROFILER_SAMPLESHEET_HEADERS.extend(NFX_SAMPLESHEET_READS_HEADERS, TAXPROFILER_FASTA_HEADER)
# TAXPROFILER_SAMPLESHEET_HEADERS.append(TAXPROFILER_FASTA_HEADER)
