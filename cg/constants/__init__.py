...
from .compression import (FASTQ_DELTA, FASTQ_FIRST_READ_SUFFIX,
                          FASTQ_SECOND_READ_SUFFIX, SPRING_SUFFIX)
from .constants import (CAPTUREKIT_CANCER_OPTIONS, CAPTUREKIT_OPTIONS,
                        CASE_ACTIONS, COLLABORATORS, COMBOS, CONTAINER_OPTIONS,
                        DEFAULT_CAPTURE_KIT, FLOWCELL_STATUS, PREP_CATEGORIES,
                        SEX_OPTIONS, STATUS_OPTIONS, DataDelivery, Pipeline)
...
from .tags import (HK_FASTQ_TAGS, HK_TAGS, MICROSALT_TAGS, MIP_DNA_TAGS,
                   MIP_RNA_TAGS)
