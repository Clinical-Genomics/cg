...
@pytest.fixture
def hiseq_sequencing_times_service() -> HiseqSequencingTimesService:
    return HiseqSequencingTimesService()


@pytest.fixture
def hiseq_sequencing_start_time(
