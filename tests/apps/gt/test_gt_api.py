...
def test_instatiate(genotype_config):
    ...
    # GIVEN a genotype api with some configs
...
def test_get_trending(genotypeapi, genotype_trending_output, mocker):
    ...
    subprocess.check_output.return_value = genotype_trending_output
    case_obj = genotypeapi.get_trending(days=days)
