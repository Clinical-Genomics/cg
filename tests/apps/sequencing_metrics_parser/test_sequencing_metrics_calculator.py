...
@pytest.mark.parametrize(
    "q30_yield, total_yield, expected_result",
    [(100, 200, 0.5 * 100), (0, 0, 0)],
)
def test_calculate_bases_with_q30_percentage(
    ...
    q30_percentage = calculate_q30_bases_percentage(
        q30_yield=q30_yield,
...
@pytest.mark.parametrize(
    "total_quality_score, total_yield, expected_result",
    [(100, 200, 0.5), (0, 0, 0)],
)
