...
def microbial_order():
    ...
    order = {'customer': 'cust000',
        ...
        dict(name='Jag', internal_id='ms1', reads='1000', container='96 well plate',
             container_name='hej',
             rml_plate_name=None,
             well_position='D:5', well_position_rml=None, sex=None, panels=None, require_qcok=True,
             application='MWRNXTR003', source=None, status=None, customer='cust015', family=None,
             priority='standard', capture_kit=None, comment=None, index=None, reagent_label=None,
        ...
        dict(name='testar', internal_id='ms2', reads='1000', container='96 well plate', container_name='hej',
             rml_plate_name=None,
             well_position='H:5', well_position_rml=None, sex=None, panels=None, require_qcok=True,
             application='MWRNXTR003', source=None, status=None, customer='cust015', family=None,
             priority='standard', capture_kit=None, comment=None, index=None, reagent_label=None,
             tumour=False, custom_index=None, eluation_buffer='Nuclease-free water', strain='Other',
             strain_other='M.upium', reference_genome='NC_222',
             extraction_method='MagNaPure 96 (contact Clinical Genomics before submission)',
             analysis='fastq', quantity='2', mother=None, father=None),
        dict(name='lite', internal_id='ms3', reads='1000', container='96 well plate', container_name='hej',
             rml_plate_name=None,
             well_position='A:6', well_position_rml=None, sex=None, panels=None, require_qcok=True,
             application='MWRNXTR003', source=None, status=None, customer='cust015', family=None,
             priority='standard', capture_kit=None, comment='3', index=None, reagent_label=None,
             tumour=False, custom_index=None, eluation_buffer='Nuclease-free water',
...
def microbial_store(base_store, microbial_order):
    ...
    print(microbial_order['customer'])
    print(customer)

    order = base_store.Order(internal_id=microbial_order['internal_id'], name=microbial_order['name'],
                             ticket_number=microbial_order['ticket_number'], comment=microbial_order['comment'],
                             created_at=dt.datetime(2012, 3, 3, 10, 10, 10), updated_at=dt.datetime(
            2012, 3, 3, 10, 10, 10),
    ...
    for sample_data in microbial_order['items']:
        ...
        print(sample.application_version)
