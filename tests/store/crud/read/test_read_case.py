...
#     assert set(related_dna_case_ids) == set(fetched_related_dna_cases)
...
#
#     # THEN the correct set of cases is returned
#     assert fetched_related_dna_cases == set(related_dna_case_ids)
#
#
...
#
#     # THEN the correct set of cases is returned
#     assert set(fetched_related_dna_cases) == set(related_dna_case_ids)
