...
def test_get_cases_from_sample_by_workflows_within_collaborators(
    ...
    fetched_related_dna_cases: list[Case] = (
        store_with_rna_and_dna_samples_and_cases.get_cases_from_sample_by_workflows_within_collaborators(
