...
def test_analyses_to_upload_when_not_completed_at(helpers, sample_store):
    ...
    records = [analysis_obj for analysis_obj in sample_store.get_analyses_to_upload()]
...
def test_analyses_to_upload_when_no_pipeline(helpers, sample_store, timestamp):
    ...
    records = [analysis_obj for analysis_obj in sample_store.get_analyses_to_upload(pipeline=None)]
