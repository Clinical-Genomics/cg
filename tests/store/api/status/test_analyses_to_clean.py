...
def test_analysis_included(analysis_store: Store, helpers):
    ...
    analyses_to_clean = analysis_store.analyses_to_clean(before=analysis.started_at)
...
def test_analysis_excluded(analysis_store: Store, helpers):
    ...
    # WHEN calling the analyses_to_clean
    analyses_to_clean = analysis_store.analyses_to_clean()
...
def test_pipeline_included(analysis_store: Store, helpers):
    ...
    analyses_to_clean = analysis_store.analyses_to_clean(pipeline=pipeline, before=timestamp)
...
def test_pipeline_excluded(analysis_store: Store, helpers):
    ...
    analyses_to_clean = analysis_store.analyses_to_clean(pipeline=wrong_pipeline)
...
def test_non_cleaned_included(analysis_store: Store, helpers):
    ...
    # WHEN calling the analyses_to_clean
    analyses_to_clean = analysis_store.analyses_to_clean(before=timestamp)
