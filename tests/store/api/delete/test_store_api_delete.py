...
def test_store_api_delete_flowcell(flow_cell_name: str, populated_flow_cell_store: Store):
    ...
    populated_flow_cell_store.delete_flowcell(flowcell_name=flow_cell_name)
