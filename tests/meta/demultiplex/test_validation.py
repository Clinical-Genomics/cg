...
def test_validate_sample_sheet_exists_raises_error(hiseq_2500_custom_index_flow_cell_dir: Path):
    ...
    flow_cell = IlluminaFlowCellDirectoryData(flow_cell_path=hiseq_2500_custom_index_flow_cell_dir)
...
def test_validate_samples_have_fastq_files_passes(
    novaseqx_flow_cell_with_sample_sheet_no_fastq: IlluminaFlowCellDirectoryData,
):
