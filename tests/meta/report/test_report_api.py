...
def test_create_delivery_report(report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case):
...
def test_create_delivery_report_file(
    report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case, tmp_path: Path
):
...
def test_render_delivery_report(report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case):
...
def test_get_validated_report_data(report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case):
...
def test_get_validated_report_data_external_sample(
    report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case
):
    """Tests report data retrieval."""
...
def test_get_customer_data(report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case):
...
def test_get_report_version_version(
    report_api_mip_dna: MipDNADeliveryReportAPI,
    store: Store,
...
def test_get_samples_data(
    ...
    assert samples_data.sex == REPORT_SEX.get(str(expected_sample_data.sample.sex))
...
def test_get_sample_methods_data(
    report_api_mip_dna: MipDNADeliveryReportAPI, case_samples_data: list[CaseSample]
):
...
def test_get_case_analysis_data(report_api_mip_dna: MipDNADeliveryReportAPI, case_mip_dna: Case):
