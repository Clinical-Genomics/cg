...
snapshots["test_parse_files_dna 1"] = [
    ...
    },
    {
        ...
        "tags": ["cram", "cram-index", "mip-dna", "sample_id"],
    },
    {
        "archive": False,
        ...
        "tags": ["chanjo", "meta", "mip-dna", "sample_id", "sex-check"],
    },
    {
        "archive": False,
        ...
        "tags": ["bam", "bam-mt", "mip-dna", "sample_id"],
    },
    {
        "archive": False,
        "deliverables_tag_map": ("samtools_subsample_mt",),
        ...
        "tags": ["bam", "bam-mt-index", "mip-dna", "sample_id"],
    },
    {
        "archive": False,
        ...
        "tags": ["meta", "mip-dna", "sample_id", "smn-calling", "smncopynumbercaller"],
    },
    {
        "archive": False,
    ...
    },
    {
        ...
        "tags": ["case_id", "mip-dna", "vcf", "vcf-sv-clinical"],
    },
    {
        "archive": False,
        "deliverables_tag_map": ("sv_reformat", "clinical"),
        ...
        "tags": ["case_id", "mip-dna", "vcf", "vcf-sv-clinical-index"],
    },
    {
        "archive": False,
        ...
        "tags": ["meta", "mip-dna", "sample_id", "vcf2cytosure"],
    },
    {
        "archive": False,
        ...
        "tags": ["case_id", "meta", "mip-dna", "ped", "peddy"],
    },
    {
        "archive": False,
        ...
        "tags": ["case_id", "meta", "mip-dna", "ped-check", "peddy"],
    },
    {
        "archive": False,
        ...
        "tags": ["case_id", "meta", "mip-dna", "peddy", "sex-check"],
    },
    {
        "archive": False,
    ...
    },
    {
        ...
        "tags": ["case_id", "meta", "mip-dna", "qcmetrics"],
    },
    {
        "archive": False,
        "deliverables_tag_map": ("version_collect_ar",),
        "path": "/path/to/rare-disease/cases/case_id/analysis/case_id/version_collect_ar/case_id_vcol.yaml",
        "tags": ["case_id", "exe-ver", "meta", "mip-dna"],
    },
    {
        "archive": False,
        "deliverables_tag_map": ("multiqc_ar", "html"),
        "path": "/path/to/rare-disease/cases/case_id/analysis/case_id/multiqc_ar/multiqc_report.html",
        "tags": ["case_id", "meta", "mip-dna", "multiqc-html"],
    },
    {
        "archive": False,
        "deliverables_tag_map": ("multiqc_ar", "json"),
        "path": "/path/to/rare-disease/cases/case_id/analysis/case_id/multiqc_ar/multiqc_data/multiqc_data.json",
        "tags": ["case_id", "meta", "mip-dna", "multiqc-json"],
    },
    {
        "archive": False,
    ...
    },
    {
        ...
        "tags": ["chromograph", "mip-dna", "sample_id", "tar"],
    },
    {
        "archive": False,
