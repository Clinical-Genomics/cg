...
from cg.constants.priority import (
    SlurmAccount,
    SlurmQos,
)
...
from tests.meta.deliver.conftest import (
...
def test_slurm_quality_of_service_production(
    rsync_api: RsyncAPI,
):
...
def test_slurm_quality_of_service_other(
    rsync_api: RsyncAPI,
):
    # GIVEN an RsyncAPI instance
