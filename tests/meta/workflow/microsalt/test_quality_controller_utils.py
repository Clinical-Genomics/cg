...
from cg.meta.workflow.microsalt.quality_controller.models import SampleQualityResults
...
def test_negative_control_passes_qc():
    ...
    control_result: SampleQualityResults = create_quality_result(is_control=True)
    other_result: SampleQualityResults = create_quality_result(passes_qc=False)
...
def test_negative_control_fails_qc():
    ...
    control_result: SampleQualityResults = create_quality_result(is_control=True, passes_qc=False)
    other_result: SampleQualityResults = create_quality_result()
...
def test_get_urgent_results():
    ...
    urgent_result: SampleQualityResults = create_quality_result(
        application_tag=MicrosaltAppTags.MWRNXTR003, passes_qc=True
    )
    non_urgent_result: SampleQualityResults = create_quality_result(
        application_tag=MicrosaltAppTags.MWXNXTR003, passes_qc=True
    )
    quality_results: list[SampleQualityResults] = [urgent_result, non_urgent_result]

    # WHEN getting the urgent results
    urgent_results: list[SampleQualityResults] = get_urgent_results(quality_results)
...
def test_urgent_samples_pass_qc():
    ...
    urgent_result_control: SampleQualityResults = create_quality_result(
        application_tag=MicrosaltAppTags.MWRNXTR003, passes_qc=True, is_control=True
    )
    urgent_results: list[SampleQualityResults] = [urgent_result, urgent_result_control]
...
def test_get_non_urgent_results():
    ...
    non_urgent_results: list[SampleQualityResults] = get_non_urgent_results(quality_results)
...
def test_non_urgent_samples_pass_qc():
    ...
    non_urgent_result_control: SampleQualityResults = create_quality_result(
        application_tag=MicrosaltAppTags.MWXNXTR003, passes_qc=True, is_control=True
    )
    non_urgent_results: list[SampleQualityResults] = [non_urgent_result, non_urgent_result_control]
