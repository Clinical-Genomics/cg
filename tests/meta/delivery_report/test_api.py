...
def test_get_delivery_report_html_balsamic():
    ...
    expected_table = """  <h4 class="mt-4 mb-3">Kvalitetsmått</h4>\n'
 '  <table class="table w-auto text-center align-middle" '
 'aria-describedby="qc-metrics-table">\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Antal sekvenseringsläsningar i miljoner '
 'läspar.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Sekvenseringsläsningar som är i duplikat och '
 'därmed ej unika sekvenser. Hög mängd duplikat kan tyda på dålig komplexitet '
 'av sekvenserat bibliotek eller djup sekvensering.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Medelstorlek av provbiblioteken som laddats '
 'på sekvenseringsinstrument.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Jämnhet av täckningsgraden över alla gener i '
 'analyspanlen.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Median av täckningen över alla baser '
 'inkluderade i analysen. Det beräknas efter borttagning av duplikata '
 'läsningar.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Andel baser som är sekvenserade med ett djup '
 'över en specificerad gräns (250x). Det beräknas efter borttagning av '
 'duplikata läsningar.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '        \n'
 '        <td class="text-start">Andel baser som är sekvenserade med ett djup '
 'över en specificerad gräns (500x). Det beräknas efter borttagning av '
 'duplikata läsningar.</td>\n'
 '      </tr>\n'
 '      \n'
 '      <tr>\n'
 ...
 '          <td>1.0</td>\n'
 '        \n'
 '        <td class="text-start">Ett mått på hur dåligt täckta områden, med '
 '&gt;= 50% GC innehåll, är i jämförelse med medelvärdet. Om värdet är 5%, '
 'innebär det att 5% av alla läsningar som borde ha kartlagts till områden med '
 'GC &lt;= 50%, kartlades någon annanstans.</td>\n'
 '      </tr>\n'
 '      \n'
 '    </tbody>\n'
 '  </table>\n'"""
    assert expected_table in delivery_report
