...
from cg.models.balsamic.config import BalsamicConfigJSON, BalsamicConfigPanel
...
def balsamic_tga_analysis():
    return BalsamicAnalysis(
        ...
        sample_metrics={
            "sample_id": create_autospec(BalsamicTargetedQCMetrics, percent_duplication=-99.99)
        },
    )
