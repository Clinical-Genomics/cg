...
def test_mip_dna_get_sample_coverage(mocker: MockerFixture):
    ...
    chanjo_api.sample_coverage = Mock(return_value=expected_coverage)
    ...
    analysis_api: MipDNAAnalysisAPI = create_autospec(
        MipDNAAnalysisAPI,
    ...
    case: Case = create_autospec(Case, panels=["some_panel"])
