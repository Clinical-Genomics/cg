...
def all_orders_to_submit(
    ...
    return {
        OrderType.BALSAMIC: OrderIn.parse_obj(
            balsamic_order_to_submit,
            project=OrderType.BALSAMIC,
        ),
        OrderType.FASTQ: OrderIn.parse_obj(
            fastq_order_to_submit,
            project=OrderType.FASTQ,
        ),
        OrderType.FLUFFY: OrderIn.parse_obj(
            rml_order_to_submit,
            project=OrderType.FLUFFY,
        ),
        OrderType.METAGENOME: OrderIn.parse_obj(
            metagenome_order_to_submit,
            project=OrderType.METAGENOME,
        ),
        OrderType.MICROSALT: OrderIn.parse_obj(
            microbial_order_to_submit,
            project=OrderType.MICROSALT,
        ),
        OrderType.MIP_DNA: OrderIn.parse_obj(
            mip_order_to_submit,
            project=OrderType.MIP_DNA,
        ),
        OrderType.MIP_RNA: OrderIn.parse_obj(
            mip_rna_order_to_submit,
            project=OrderType.MIP_RNA,
        ),
        OrderType.RML: OrderIn.parse_obj(
            rml_order_to_submit,
            project=OrderType.RML,
        ),
        OrderType.RNAFUSION: OrderIn.parse_obj(
            rnafusion_order_to_submit,
            project=OrderType.RNAFUSION,
        ),
        OrderType.SARS_COV_2: OrderIn.parse_obj(
            sarscov2_order_to_submit,
            project=OrderType.SARS_COV_2,
        ),
    }
...
def balsamic_status_data(
    ...
    order: OrderIn = OrderIn.parse_obj(
        obj=balsamic_order_to_submit,
        project=project,
    )
...
def metagenome_status_data(
    ...
    order: OrderIn = OrderIn.parse_obj(
        obj=metagenome_order_to_submit,
        project=project,
    )
