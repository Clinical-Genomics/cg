...
def test_submit(
    ...
    result = orders_api.submit(
        project=order_type, order_dict=order_data.dict(), user_name=user_name, user_mail=user_mail
    )
...
def test_submit_ticketexception(
    ...
    order_data = all_json_orders_to_submit[order_type]
