...
def test_observations_get_input(analysis_store, case_id, observations_api):

    # GIVEN an observations_api and a mocked analysis_obj
    ...
    input_files = observations_api.get_input(analysis_obj)
...
def test_observations_get_input_wes(analysis_store, case_id, observations_api_wes):
    ...
    # WHEN get_input method is used given the analysis_obj as argument
    input_files = observations_api_wes.get_input(analysis_obj)
...
def test_observations_process(analysis_store, case_id, observations_api):
    ...
    observations_api.process(analysis_obj)
