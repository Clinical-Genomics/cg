...
class StoreHelpers:
    ...
    def ensure_bed_version(store: Store, bed_name: str = "dummy_bed") -> BedVersion:
        ...
        if not bed:
            bed: Bed = StoreHelpers.add_bed(name=bed_name)
            store.session.add(bed)

        bed_version: BedVersion = StoreHelpers.add_bed_version(
    ...
    def add_case(
        ...
        case_obj.aggregated_sequencing_qc = aggregated_sequencing_qc
