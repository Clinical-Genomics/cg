        ...
        **kwargs,
        ...
        if not case_obj:
            case_obj = store.add_case(
                ...
                panels=panels,
                ticket=ticket,
                priority=kwargs.get("priority", PriorityTerms.STANDARD),
            )
        if action:
