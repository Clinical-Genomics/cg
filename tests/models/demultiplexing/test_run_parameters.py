...
def test_reagent_kit_version(novaseq_run_parameters: Path):
    ...
    run_parameters = RunParametersNovaSeq6000(run_parameters_path=novaseq_run_parameters)
...
def test_reagent_kit_version_missing_version(run_parameters_missing_flowcell_type: Path, caplog):
    ...
    run_parameters = RunParametersNovaSeq6000(
        run_parameters_path=run_parameters_missing_flowcell_type
    )
...
def test_index_length_different_length(run_parameters_different_index: Path):
    ...
    run_parameters = RunParametersNovaSeq6000(run_parameters_path=run_parameters_different_index)
