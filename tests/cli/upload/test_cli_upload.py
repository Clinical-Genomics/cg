...
def test_upload_started_long_time_ago_raises_exception(invoke_cli, disk_store: Store):
    ...
    add_analysis(disk_store, family_id=family_id, uploading=True, upload_started=upload_started)
...
def add_analysis(disk_store, family_id, uploading=False, uploaded=False,
