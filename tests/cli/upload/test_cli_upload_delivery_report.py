"""Tests the cli for uploading file_delivery reports."""
...
def test_delivery_report_to_scout_no_params(upload_context: CGConfig, cli_runner: CliRunner):
    ...
    # WHEN invoking the file_delivery report upload without parameters
...
def test_delivery_report_to_scout(
    ...
    """Tests the upload to Scout of a MIP DNA file_delivery report."""
