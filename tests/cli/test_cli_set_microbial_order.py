...
# def test_sex(invoke_cli, disk_store: Store):
#     # GIVEN a database with a female sample
#
#     order_id = add_sample(disk_store, sex='female').internal_id
#     new_sex = 'male'
#     assert disk_store.Sample.query.first().sex != new_sex
#
#     # WHEN setting sex on sample to male
#     result = invoke_cli(
#         ['--database', disk_store.uri, 'set', 'microbial_order', order_id, '--sex', new_sex])
#
...
#
#
# def test_invalid_customer(invoke_cli, disk_store: Store):
...
#     result = invoke_cli(
#         ['--database', disk_store.uri, 'set', 'microbial_order', order_id, '-c', customer_id])
#
#     # THEN then it should complain about missing customer instead of setting the value
#     assert result.exit_code == 1
#
#
# def test_customer(invoke_cli, disk_store: Store):
...
#
#
# def test_comment(invoke_cli, disk_store: Store):
...
#
#
# def test_second_comment(invoke_cli, disk_store: Store):
#     # GIVEN a database with a sample that has a comment
#     order_id = add_sample(disk_store).internal_id
#     comment = 'comment'
#     second_comment = 'comment2'
#     invoke_cli(['--database', disk_store.uri, 'set', 'microbial_order', order_id, '-C', comment])
#     assert comment in disk_store.Sample.query.first().comment
#     assert second_comment not in disk_store.Sample.query.first().comment
#
#     # WHEN calling set sample with second comment
#     result = invoke_cli(
#         ['--database', disk_store.uri, 'set', 'microbial_order', order_id, '-C', second_comment])
#
...
#
#
# def test_invalid_downsampled_to(invoke_cli, disk_store: Store):
#     # GIVEN a database with a sample
#     order_id = add_sample(disk_store).internal_id
...
#     result = invoke_cli(
#         ['--database', disk_store.uri, 'set', 'microbial_order', order_id, '-d', downsampled_to])
#
...
#
#
# def test_downsampled_to(invoke_cli, disk_store: Store):
#     # GIVEN a database with a sample
#     order_id = add_sample(disk_store).internal_id
...
#     result = invoke_cli(['--database', disk_store.uri, 'set', 'microbial_order', order_id, '-a',
#                          application_tag])
#
...
#
#
# def test_capture_kit(invoke_cli, disk_store: Store):
#     # GIVEN a database with a sample
#     order_id = add_sample(disk_store).internal_id
...
#     result = invoke_cli(
#         ['--database', disk_store.uri, 'set', 'microbial_order', order_id, '-k', capture_kit])
#
...
#
#
# def add_sample(disk_store, order_id='sample_test', sex='female'):
#     """utility function to add a sample to use in tests"""
#     customer = ensure_customer(disk_store)
#     application_version_id = ensure_application_version(disk_store).id
#     sample = disk_store.add_sample(name=order_id, sex=sex)
