...
def test_cg_workflow_mip_rna_config_case_dry_run(cli_runner, caplog, case_id, mip_context):
    ...
    assert f"config-case --dry-run {case_id}"


def test_cg_workflow_mip_rna_config_case(cli_runner, caplog, case_id, mip_context):
