...
def test_cli_store(
    ...
    assert not fluffy_analysis_api.status_db.get_case_by_internal_id(fluffy_case_id_existing).action
...
def test_cli_store_available_case_not_running(
    ...
    fluffy_analysis_api.status_db.get_case_by_internal_id(fluffy_case_id_existing).action = None
