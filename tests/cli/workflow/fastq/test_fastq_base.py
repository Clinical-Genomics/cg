...
def test_store_raw_data_analysis(another_case_id: str, cli_runner, raw_data_fastq_context, helpers):
    ...
    helpers.ensure_case(raw_data_fastq_context.status_db, case_id=another_case_id, order=create_autospec(Order))  # type: ignore pydantic model
    ...
    cli_runner.invoke(store_raw_data_analysis, [another_case_id], obj=raw_data_fastq_context , catch_exceptions=False) 
