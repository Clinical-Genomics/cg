...
def test_add_flowcell_cmd(
    ...
    assert not get_flowcell_id(manager=stats_api, flowcell_name=flowcell_object.flowcell_id)
    ...
    assert get_flowcell_id(manager=stats_api, flowcell_name=flowcell_object.flowcell_id)
