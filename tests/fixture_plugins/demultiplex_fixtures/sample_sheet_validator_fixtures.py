...
def hiseq_x_single_index_sample_sheet_validator(
    ...
    return SampleSheetValidator(hiseq_x_single_index_sample_sheet_path)
...
def hiseq_x_single_index_bcl2fastq_sample_sheet_validator(
    ...
    return SampleSheetValidator(hiseq_x_single_index_bcl2fastq_sample_sheet)
...
def hiseq_x_dual_index_sample_sheet_validator(
    ...
    """Return a HiseqX dual index sample sheet validator."""
    return SampleSheetValidator(hiseq_x_dual_index_sample_sheet_path)
...
def hiseq_x_dual_index_bcl2fastq_sample_sheet_validator(
    ...
    return SampleSheetValidator(hiseq_x_dual_index_bcl2fastq_sample_sheet)
...
def hiseq_2500_dual_index_sample_sheet_validator(
    ...
    return SampleSheetValidator(hiseq_2500_dual_index_sample_sheet_path)
...
def hiseq_2500_dual_index_bcl2fastq_sample_sheet_validator(
    ...
    """Return a Hiseq 2500 dual index sample sheet validator."""
    return SampleSheetValidator(hiseq_2500_dual_index_bcl2fastq_sample_sheet)
...
def hiseq_2500_custom_index_sample_sheet_validator(
    ...
    return SampleSheetValidator(hiseq_2500_custom_index_sample_sheet_path)
...
def hiseq_2500_custom_index_bcl2fastq_sample_sheet_validator(
    ...
    """Return a Hiseq 2500 custom index sample sheet validator."""
    return SampleSheetValidator(hiseq_2500_custom_index_bcl2fastq_sample_sheet)
...
def novaseq_6000_pre_1_5_kits_sample_sheet_validator(
    ...
    return SampleSheetValidator(novaseq_6000_pre_1_5_kits_correct_sample_sheet_path)
...
def novaseq_6000_post_1_5_kits_sample_sheet_validator(
    ...
    return SampleSheetValidator(novaseq_6000_post_1_5_kits_correct_sample_sheet_path)
...
def novaseq_x_sample_sheet_validator(
    ...
    return SampleSheetValidator(novaseq_x_correct_sample_sheet)
