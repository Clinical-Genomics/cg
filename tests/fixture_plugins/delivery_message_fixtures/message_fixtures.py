...
def analysis_scout_message(mip_case_id: str, customer_id: str, ticket_id: str) -> str:
    ...
    return (
        ...
        "The analysis files have been uploaded to your inbox on Caesar:\n\n"
...
def microsalt_message(customer_id: str, ticket_id: str) -> str:
    ...
    return (
        "Hello,\n\n"
        "The analysis is now complete. The fastq files and relevant reports have been uploaded to:\n\n"
        f"/home/{customer_id}/inbox/{ticket_id} \n\n"
        f"{REMINDER_TO_DOWNLOAD_MESSAGE}"
    )
...
def raw_data_analysis_message() -> str:
    ...
    return (
        "Hello,\n\n"
        "The raw data and analysis files for the following case have been "
...
def raw_data_analysis_scout38_message() -> str:
    ...
    return (
        ...
        "The raw data and analysis files have been uploaded to your inbox on Caesar:\n\n"
        "/home/{customer_id}/inbox/{ticket_id} \n\n"
        f"{REMINDER_TO_DOWNLOAD_MESSAGE}"
    )
