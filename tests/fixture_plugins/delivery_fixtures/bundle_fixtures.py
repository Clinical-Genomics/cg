...
def hk_delivery_sample_bundle(
    ...
    sample_id: str,
    hk_spring_sample_file: Path,
    hk_fastq_sample_file: Path,
) -> dict:
    ...
    sample_hk_bundle["files"] = [
        {
            "archive": False,
            "path": hk_fastq_sample_file.as_posix(),
            "tags": [SequencingFileTag.FASTQ, sample_id],
        },
        {
            "archive": False,
            "path": hk_spring_sample_file.as_posix(),
...
def hk_delivery_another_sample_bundle(
    ...
    hk_spring_another_sample_file: Path,
    hk_fastq_another_sample_file: Path,
) -> dict:
    sample_hk_bundle: dict[str, Any] = deepcopy(sample_hk_bundle_no_files)
    ...
    sample_hk_bundle["files"] = [
        {
            "archive": False,
            "path": hk_fastq_another_sample_file.as_posix(),
            "tags": [SequencingFileTag.FASTQ, another_sample_id],
        },
        {
            "archive": False,
            "path": hk_spring_another_sample_file.as_posix(),
...
def hk_delivery_case_bundle(
    ...
    sample_id: str,
    another_sample_id: str,
    hk_case_report_file: Path,
    hk_sample_cram_file: Path,
    hk_another_sample_cram_file: Path,
) -> dict:
    ...
    case_hk_bundle["files"] = [
        {
            "archive": False,
            "path": hk_case_report_file.as_posix(),
            "tags": [HK_DELIVERY_REPORT_TAG, case_id],
        },
        {
            "archive": False,
            "path": hk_sample_cram_file.as_posix(),
            "tags": [AlignmentFileTag.CRAM, sample_id],
        },
        {
            "archive": False,
            "path": hk_another_sample_cram_file.as_posix(),
